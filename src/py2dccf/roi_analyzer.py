...
from src.py2dccf.util import allenccf_bregma, PLANE_TYPE, load_structure_tree, ImageReader
...
class ROIMapper:
    ...
    def run_analysis(self):
        ...
        for i, img in enumerate(self.images):
            ...
            slice_img = ImageReader(img)  # transformed
...
def main(args: List[str] = None):
    ...
    ap.add_argument('-C', '--channel', choices=get_args(ROI_CHANNEL_TYPE), required=True)
